...
const Hero = () => {
    return (
        <div className="mx-2 py-20">
            ...
            <div className=" mt-10 flex  lg:flex-row items-end gap-5 lg:gap-10">
                <div className='w-1/3'>
                    <img src={Annie} alt="" className='w-60 h-60 rounded-xl' />
                </div>
                <div className='w-2/3 lg:w-1/3'>
                    <p className="text-sm lg:text-2xl lg:font-bold">
                    ...
                    <button className="mt-10 bg-transparent border hover:rotate-12 flex justify-between gap-3 items-center p-2 rounded-lg text-xl font-bold  transition-colors duration-300">
                ...
                <span className="rotate-90 flex flex-col items-end">
                    <Button></Button>
